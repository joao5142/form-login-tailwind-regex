<h1>Projeto validação login</h1>
<h4>🚀 Projeto validação login com tailwind css e regex</h4>
...
<h4  style="display: inline_block">Visualização do site :</h4><a style="display: inline_block" target="blank" href="https://joao5142.github.io/form-login-tailwind-regex/">Preview no Github Pages</a>
